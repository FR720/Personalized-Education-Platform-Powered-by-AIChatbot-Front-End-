                          ...
                          <div className="space-y-4">
                            <div className="flex items-start space-x-4">
                              ...
                              <div className="flex-1 bg-white dark:bg-slate-900 rounded-lg p-4 shadow-sm border border-slate-200 dark:border-slate-800">
                                ...
                                <p className="text-slate-600 dark:text-slate-300">
                                  Welcome to the course discussion! Feel free to
                                  ask questions about any of the course material
                                  here.
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="flex items-start space-x-4">
                              ...
                              <div className="flex-1 bg-white dark:bg-slate-900 rounded-lg p-4 shadow-sm border border-slate-200 dark:border-slate-800">
                                ...
                                <p className="text-slate-600 dark:text-slate-300">
                                  Supervised learning uses labeled data where
                                  the algorithm learns the mapping between
                                  inputs and outputs. Unsupervised learning
                                  works with unlabeled data and tries to find
                        ...
                        <CardContent className="pt-6">
                          <div className="bg-yellow-50 dark:bg-yellow-900/10 border border-yellow-200 dark:border-yellow-900/50 rounded-lg p-4 mb-4">
                            ...
                            <p className="text-sm text-yellow-700 dark:text-yellow-300">
                              ...
                              predicts categories, regression predicts
                              continuous values. Common algorithms: Decision
