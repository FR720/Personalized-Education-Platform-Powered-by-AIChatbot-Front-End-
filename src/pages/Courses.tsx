...
const allCourses = [
  ...
  },
  {
    ...
    description:
      "Learn effective digital marketing techniques for modern businesses.",
    duration: "7 hours",
    category: "Marketing",
    level: "Beginner",
    enrolled: false,
    rating: 4.2,
    image:
      "https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&q=80&w=500&h=300",
  },
];
      ...
      <div className="aspect-[16/9] bg-slate-100 dark:bg-slate-800 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-4">
          <div className="flex items-center justify-between">
            <Badge
              variant="secondary"
              className="bg-white/90 text-slate-900 dark:bg-slate-800/90 dark:text-slate-200"
            >
              {course.category}
            </Badge>
            <Badge
              variant="outline"
              className="bg-white/80 text-slate-900 border-none dark:bg-slate-800/80 dark:text-slate-200"
            >
