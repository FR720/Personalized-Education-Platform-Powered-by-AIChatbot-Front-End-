      ...
      <section className="pt-32 pb-24 px-4 sm:px-6 relative">
        ...
        <div className="max-w-5xl mx-auto relative">
          <div className="flex flex-col items-center text-center">
            <div
              className={`opacity-0 ${isLoaded ? "animate-slide-down" : ""}`}
            ...
            <div className="grid md:grid-cols-2">
              <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center">
                ...
                <p className="text-slate-600 dark:text-slate-300 mb-8">
                  Join thousands of learners who have enhanced their skills and
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="p-8 max-w-md text-white">
                    ...
                    <blockquote className="text-xl font-medium italic mb-4">
                      "This platform transformed how I approach online learning.
                      The interface is intuitive and the AI recommendations are
                      spot-on."
                    </blockquote>
