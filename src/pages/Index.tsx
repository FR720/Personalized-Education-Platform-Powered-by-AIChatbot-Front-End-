...
import { ArrowRight, CheckCircle, BookOpen, Video, MessageCircle } from "lucide-react";
          ...
          <section className="pt-32 pb-24 px-4 sm:px-6 relative">
            ...
            <div className="max-w-5xl mx-auto relative">
              <div className="flex flex-col items-center text-center">
                <div className={`opacity-0 ${isLoaded ? "animate-slide-down" : ""}`} style={{ animationDelay: "100ms" }}>
                ...
                <h1 
                  className={`text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white mb-6 opacity-0 ${isLoaded ? "animate-slide-down" : ""}`}
                  style={{ animationDelay: "200ms", lineHeight: "1.1" }}
                >
                  Elevate Your Learning Experience
                </h1>
                <p 
                  className={`text-lg md:text-xl text-slate-600 dark:text-slate-300 max-w-2xl mb-8 opacity-0 ${isLoaded ? "animate-slide-down" : ""}`}
                  style={{ animationDelay: "300ms" }}
                >
                  Discover a seamless course navigation system designed with elegance and simplicity. Access courses, track progress, and receive personalized guidance.
                </p>
                
                <div 
                  className={`flex flex-wrap justify-center gap-4 mb-12 opacity-0 ${isLoaded ? "animate-slide-down" : ""}`}
                ...
                <div 
                  className={`relative w-full max-w-4xl mx-auto rounded-xl overflow-hidden shadow-glossy opacity-0 ${isLoaded ? "animate-slide-up" : ""}`}
                          ...
                          <div className="flex h-4/5">
                            <div className="w-1/4 p-2 border-r border-slate-200 dark:border-slate-700">
                              <div className="h-full flex flex-col space-y-2">
                                {[1, 2, 3, 4].map(i => (
                                  <div key={i} className="h-10 rounded bg-slate-100 dark:bg-slate-800 flex items-center p-2">
                            ...
                            <div className="w-3/4 p-4">
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                {[1, 2, 3, 4].map(i => (
                                  <div key={i} className="aspect-video rounded-lg bg-slate-100 dark:bg-slate-800 p-3 flex flex-col justify-between">
          ...
          <section className="py-24 px-4 sm:px-6 bg-white dark:bg-slate-950">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-4">Experience the Future of Learning</h2>
                <p className="text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">Our platform combines elegant design with powerful features to create a seamless learning journey.</p>
              </div>
                ...
                {[
                  {
                    ...
                    description: "Browse and enroll in a variety of courses with rich multimedia content and interactive elements."
                  },
                  {
                    icon: <Video className="h-8 w-8 text-blue-600" />,
                    title: "Video Lectures & Quizzes",
                    description: "Access high-quality video lectures and test your knowledge with comprehensive quizzes."
                  },
                  {
                    icon: <MessageCircle className="h-8 w-8 text-blue-600" />,
                    title: "AI Learning Assistant",
                    description: "Get personalized recommendations and answers to your questions from our intelligent AI assistant."
                  }
                ].map((feature, index) => (
                  <div 
                    key={index} 
              ...
              <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-glossy overflow-hidden">
                <div className="grid md:grid-cols-2">
                  <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center">
                    <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-6">Ready to Transform Your Learning?</h2>
                    <p className="text-slate-600 dark:text-slate-300 mb-8">Join thousands of learners who have enhanced their skills and knowledge through our platform.</p>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="p-8 max-w-md text-white">
                        ...
                        <blockquote className="text-xl font-medium italic mb-4">
                          "This platform transformed how I approach online learning. The interface is intuitive and the AI recommendations are spot-on."
                        </blockquote>
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <div className="text-sm opacity-70">Software Developer</div>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row justify-between items-center">
                <div className="mb-6 md:mb-0">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 mt-2">Elevating your learning experience</p>
                </div>
